...
LOGGING = {
    ...
    'handlers': {
        ...
        **(
            ...
            } if not DEBUG and AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY and AWS_SESSION_TOKEN and AWS_REGION else {}
        ),
    },
    'loggers': {
        'django': {
            'handlers': ['console'] + ([] if DEBUG else ['cloudwatch'] if AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY and AWS_SESSION_TOKEN and AWS_REGION else []),
            'level': 'INFO',
            'propagate': False,
        },
        'watchtower': {
